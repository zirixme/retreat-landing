  ...
  return (
    ...
    >
      <motion.div
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="min-h-[300px] lg:min-h-[395px] max-w-md lg:max-w-3xl md:max-w-lg w-full flex flex-col justify-center md:p-7 md:col-span-2 lg:col-span-2 2xl:col-span-4 md:text-center"
      >
        <motion.h1
          variants={fadeInUp}
